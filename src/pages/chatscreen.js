...
import FacebookTabBar from 'funshare/src/components/FacebookTabBar';
...
goTochattab(){
  this.props.replaceRoute(Routes.chatscreen(2));
}
render() {
  const TopNavigation = () => (
  ...
  return (
    ...
    <ScrollableTabView
      ...
      <Text style={{color:'white', fontSize:30,fontWeight:'bold',marginTop:25}}>it's an Offer!</Text>
      </View>
      ...
      <ScrollView tabLabel="ios-refresh-circle-outline" style={styles.tabView}>
          <View style= {{flex:1}}>
          <PendingOffers goTochattab = {this.goTochattab.bind(this)}  />
          </View>
     </ScrollView>
